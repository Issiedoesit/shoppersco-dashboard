...
import BrandInsightTable from './brandInsightTable'
import $ from 'jquery'
  ...
  return (
    <div className='col-span-3 bg-white rounded-ten p-7'>
      <div className='flex flex-row pb-10 justify-between items-center gap-5'>
            ...
            <label htmlFor="userInsightSearch" className='rounded-ten py-2.5 border-0.5 flex flex-row items-center gap-2 pl-2 border-brandGray4x w-sixtyPercent max-w-md'>
