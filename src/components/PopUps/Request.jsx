...
const Request = ({buttons, reqName, paddingB, paddingT, handleApproval, handleReject, actionBtnText, secBtnText, actionBtnTextColor, secBtnTextColor, actionBtnBgColor, secBtnBgColor}) => {
  return (
