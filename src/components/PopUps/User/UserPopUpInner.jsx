...
const UserPopUpInner = ({user, location}) => {
  return (
    <section className='bg-white z-50 rounded-ten w-ninetyFivePercent sm:w-eightyPercent lg:w-sixtyPercent h-fit m-auto'>
            ...
            <div className='rounded-b-ten px-5 sm:px-10 md:px-14 py-5 sm:py-10'>
                ...
                <div className='flex flex-col-reverse sm:flex-row w-full sm:w-auto gap-5 border-b-0.5 border-b-brandGray27x py-2.5 justify-between items-center'>
