      ...
      <div className='pb-10 overflow-y-auto'>
        ...
        <div>
          <label htmlFor="searchInsights" className='flex items-center gap-7 py-3 px-18px border-0.5 border-brandGray37x bg-brandGray38x rounded-fifty'>
            ...
            <input type="search" name="search-insights" id="searchInsights" placeholder='Search Insights by keyword' className="w-full bg-transparent focus:outline-none focus:ring-none text-sm font-avenirLight text-brandGray39x"/>
          </label>
        </div>

        <div className='grid grid-cols-5 pb-5 gap-2 gap-y-5 2xl:gap-5 pt-10 auto-rows-fr'>
