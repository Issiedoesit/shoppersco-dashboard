  ...
  return (
    <div className='rounded-ten bg-white col-span-4 py-9 px-6'>
       ...
       <div className='pb-3 flex flex-col sm:flex-row md:items-center gap-5 sm:gap-10'>
            <h1 className='font-avenirBlack whitespace-nowrap'>Campaign Insight</h1>
            <div className='flex flex-col md:flex-row w-full gap-3 items-end'>
              ...
              <label htmlFor="campaignInsightSearch" className='rounded-ten py-2.5 border-0.5 flex flex-row items-center gap-2 pl-2 border-brandGray4x w-full sm:w-sixtyPercent max-w-md'>
                ...
                <input onChange={handleSearch} onBlur={handleBlur} type="search" name="campaign-insight-search" id="campaignInsightSearch" placeholder='Search by name. date, location or status' className='placeholder:text-xs w-full focus:outline-none focus:ring-none text-sm'/>
            </label>
            </div>
        </div>
