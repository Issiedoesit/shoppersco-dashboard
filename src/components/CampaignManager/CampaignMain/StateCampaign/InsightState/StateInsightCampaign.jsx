...
const CampaignStateMain = () => {
  return (
    <div className='rounded-ten bg-white col-span-4 py-9 px-6'>
      
       <div className='pb-3 flex items-center gap-10 justify-between w-full'>
            <h1 className='font-avenirBlack whitespace-nowrap w-fit'>Campaign Insight</h1>
              <label htmlFor="campaignInsightSearch" className='rounded-ten py-2.5 border-0.5 flex flex-row items-center gap-2 pl-2 border-brandGray4x w-sixtyPercent max-w-md'>
                ...
                <input type="search" name="campaign-insight-search" id="campaignInsightSearch" placeholder='Search by name. date, location or status' className='placeholder:text-xs w-full focus:outline-none focus:ring-none text-sm'/>
            </label>
        </div>
...
export default CampaignStateMain