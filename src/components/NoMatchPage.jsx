  ...
  return (
    <TemplatePage headerLogo={Logo}>
        <div className='m-auto py-40 flex flex-col items-center justify-center'>
           ...
           <NavLink to={'/dashboard'} className={`py-2 px-5 sm:px-8 lg:px-12 bg-brandGreen4x hover:shadow-md transition-shadow duration-500 ease-in-out rounded-five text-white font-avenirMedium text-base`}>Return to home page</NavLink>
