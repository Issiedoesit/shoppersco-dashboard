...
const RowEcoBagProducerInsight = (props) => {
  ...
  return (
    <tr id={props.id} key={props.keyprop} className='odd:bg-brandGray28x ecobag-insight-row'>
        ...
        </td>
        {
            ...
            ?
            <>
                <td className="py-3 px-1 whitespace-nowrap relative">
                    <div id={`dropBtn${props.index}`} onClick={()=>handleSubMenuOpen(props.index)} className='ecobag-drop-btn flex items-center peer'>
                        <ThreeDotsBtn />
                    </div>
                    <div id={`dropMenu${props.index}`} className={`ecobag-drop-menu absolute top-eightyPercent z-20 right-0 hidden flex-col text-xs sm:text-sm text-brandBlue1x shadow border-0.5 border-brandGray44x`}>
                        <button type='button' className='py-1 pl-4 pr-6 odd:bg-white hover:text-brandBlue2x transition-colors duration-300 ease-in-out even:bg-brandGray28x text-left'>Assign Badge</button>
                        <button type='button' className='py-1 pl-4 pr-6 odd:bg-white hover:text-brandBlue2x transition-colors duration-300 ease-in-out even:bg-brandGray28x text-left'>View Profile</button>
                        <button type='button' className='py-1 pl-4 pr-6 odd:bg-white hover:text-brandBlue2x transition-colors duration-300 ease-in-out even:bg-brandGray28x text-left'>View QR code</button>
                        <button type='button' className='py-1 pl-4 pr-6 odd:bg-white hover:text-brandBlue2x transition-colors duration-300 ease-in-out even:bg-brandGray28x text-left'>History</button>
                        <button type='button' className='py-1 pl-4 pr-6 odd:bg-white hover:text-brandBlue2x transition-colors duration-300 ease-in-out even:bg-brandGray28x text-left'>Cancel Order</button>
                    </div>
                </td>
                <td className="py-3 px-1 whitespace-nowrap">
                    <button type='button'>
