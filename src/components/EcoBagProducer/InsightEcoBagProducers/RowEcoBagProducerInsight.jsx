...
const RowEcoBagProducerInsight = ({id, avatar, index, name, user, setIsDropDownOpen,  handleKYCModal, location, orders, isAdmin, kycStatus, handleDelete, handleEdit, handleBadgeAssign, handleProfileView, handleQRCodeView, historyView, cancelOrder }) => {
